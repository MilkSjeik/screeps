var defenseManager = {
  ...
  defendRoom: function (oRoom) {
    // Tower defense
    const towers = oRoom.find(FIND_MY_STRUCTURES, { filter: (structure) => {
    ...
    if (towers.length) {
      _.forEach(towers, function (tower) {
        ...
        const closestDamagedStructure = tower.pos.findClosestByRange(FIND_MY_STRUCTURES, { filter: (structure) => {
